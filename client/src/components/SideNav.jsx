        ...
        <Sidebar className='sidenav' defaultCollapsed={true}>
            <Menu>
             <MenuItem onClick={() => {
              ...
              <MenuItem component={<Link to='/about' />} style={{ background: "#000000", }} icon={<img src="/abouticon.GIF" alt="About Me" />}>about</MenuItem>
              ...
              <MenuItem component={<Link to='/contact' />} style={{ background: "#000000"}} icon={<img src="/contacticon.GIF" alt="Contact Me" />}>contact</MenuItem>
            </Menu>
        </Sidebar>
      </div>
    </>
